		...
		$.ajax({
			...
			success: function (response) {
				...
				if ( menuOption == 'items-only') {
					dData += "<a class='rpress-checkout-cart button rpress-submit'  href='"+ checkoutUrl+"'> " + cartDetails + " Items </a>";
				}
				if ( menuOption == 'price-only') {
					dData +=  "<a class='rpress-checkout-cart button rpress-submit' href='"+ checkoutUrl +"'> $" + subtotal + "</a>";
				}
				if ( menuOption == 'both-items-price') {
					dData += "<a class='rpress-checkout-cart button rpress-submit' href='"+ checkoutUrl +"'>" + cartDetails + " Items $" + subtotal + "</a>";
				}
