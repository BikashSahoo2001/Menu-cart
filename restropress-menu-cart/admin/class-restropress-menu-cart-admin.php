...
class Restropress_Menu_Cart_Admin {
	...
	public function menu_cart( $general_settings ) {
		$general_settings['menu']['menu_cart_heading'] = array(
            ...
            'name'          => '<h3>' . __( ' Menu Cart Setting', 'restropress-menucart' ) . '</h3>',
            'desc'          => '',
            'type'          => 'header',
            'tooltip_title' => __( ' Menu Cart Setting', 'restropress-menucart' ),
        );
		$general_settings['menu']['display_cart_content'] = array(
            'id'            => 'enable_menu_cart',
            'name'          =>  __( 'Enable Menu Cart', 'restropress-menucart' ),
            'desc'          => '',
            'type'          => 'checkbox',
        );
		...
		$general_settings['menu']['always_display_cart'] = array(
            ...
            'name'          =>  __( ' Always display cart,if it empty ', 'restropress-menucart' ),
            'desc'          => '',
            'type'          => 'checkbox',
        );
		...
		$general_settings['menu']['display_icon'] = array(
            'id'            => 'display_icon',
            'class'         => 'display_icon',
            'name'          =>  __( '  Choose a cart icon. ', 'restropress-menucart' ),
            'desc'          => '',
            'type'          => 'radio',
			'options' => array(
				'1'         	=> __( 'icon 1', 'restropress-menucart' ),
				'2'            	=> __( 'icon 2', 'restropress-menucart' ),
				'3'            	=> __( 'icon 3', 'restropress-menucart' ),
				'4'			   	=> __( 'icon 4', 'restropress-menucart' ),
				'5'				=> __( 'icon 5', 'restropress-menucart' ),
		    ),
        );
		...
		$general_settings['menu']['display_menu'] = array(
            'id'            => 'display_menu',
            'class'         => 'display_menu',
            'name'          =>  __( ' What would you like to display in the menu? ', 'restropress-menucart' ),
            'desc'          => '',
            'type'          => 'radio',
			'options' => array(
                'items-only'            => __( 'Items Only', 'restropress-menucart' ),
                'price-only'            => __( 'Price Only', 'restropress-menucart' ),
                'both-items-price'      => __( 'Both Items and Price', 'restropress-menucart' ),
            ),
        );
